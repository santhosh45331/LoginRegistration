                ...
                <div class="row">
                            ...
                            <form action="{{ route('store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" name="name" id="rname" value="{{ old('name') }}"
                                        class="form-control text-bg-secondary mb-3 rounded-3" placeholder="Name" autofocus>
                                </div>
                                <div class="form-group">
                                    <input type="email" name="email" id="remail" value="{{ old('email') }}"
                                        class="form-control text-bg-secondary mb-3 rounded-3" placeholder="Email"
                                        autocomplete="email">
                                </div>
                                <div class="form-group">
                                    <input id="rpassword" type="password" class="form-control text-bg-secondary mb-2"
                                        name="password" value="{{ old('password') }}" placeholder="Password">
                                    <input type="checkbox" onclick="showPassword()"> Show Password
                                </div>

                                <br>
                                <small style="font-size:12px;">By clicking on "sign up" you are agreeing with <a
                                        href="#">Terms & Condition</a></small>
                                <br>
                                <div class="d-flex justify-content-center">
                                    <input type="submit" value="Sign up" class="btn rounded-4 px-4 mt-3 mb-5"
                                        style="background-color:#EAE5FF; width:70%;">
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="col-md-5" style="margin-top: 10%;">
                        <div class="card rounded-3">
                            <img src="{{ asset('/img/registraction/regestraction.webp') }}" alt="Registraction"
