            ...
            <div class="col-md-9 text-bg-dark rounded-3">
                ...
                <div class="row">
                        ...
                        <div class="form">
                            <form action="{{ route('authenticate') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="email" name="email" id="lemail" value="{{ old('email') }}"
                                        class="form-control text-bg-secondary mb-3 rounded-3" placeholder="Email"
                                        autocomplete="email" autofocus>
                                </div>
                                <div class="form-group">
                                    <input id="lpassword" type="password" class="form-control text-bg-secondary mb-2"
                                ...
                                <div class="d-flex justify-content-center">
                                    <input type="submit" value="Sign in" class="btn rounded-4 px-4 mt-3 mb-5"
                    ...
                    <div class="col-md-5 pt-5" style="margin-left:15px">
                        <img src="{{ asset('/img/login/login.gif') }}" alt="Registraction" width="400px" height="auto"
                            class="rounded-3">
                    </div>
                </div>
            </div>
